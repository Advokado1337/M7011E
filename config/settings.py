...
SECRET_KEY = os.getenv('SECRET_KEY', 'bad-default-key')
...
REST_FRAMEWORK = {
    ...
    # Handles throttling, works for anon but unsure about user since we have no auth implementation
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'app' / 'templates'],  # Add templates directory to the TEMPLATES setting
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
